...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CotaçãoIA · Pesquisa inteligente de preços públicos" },
      { property: "og:description", content: "Pesquisa semântica de preços em PNCP, atas e contratos, alinhada à Lei 14.133/2021." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "CotaçãoIA" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "CotaçãoIA · Pesquisa inteligente de preços públicos" },
